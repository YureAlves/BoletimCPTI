          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="aluno_boletim_etapa1_sem1">1ª Etapa</a></li>
                <li><a class="dropdown-item" href="aluno_boletim_etapa1_sem2">2ª Etapa</a></li>
                <li><a class="dropdown-item" href="aluno_boletim_etapa1_sem3">3ª Etapa</a></li>
              </ul>
